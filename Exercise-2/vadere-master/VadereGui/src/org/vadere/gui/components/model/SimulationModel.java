...
public abstract class SimulationModel<T extends DefaultSimulationConfig> extends DefaultModel {
	...
	public SimulationModel(final T config) {
		...
		/*	### Task 4-3: Group visualization
			Added colors to signify pedestrian group
				Red - Infected
				Black - Susceptible
				Blue - Recoverable
		 */
		// <<<<<<<<<<!!!>>>>>>>>>>
		this.colorMap.put(0, Color.RED);
		this.colorMap.put(1, Color.BLACK);
		this.colorMap.put(2, Color.BLUE);
		// <<<<<<<<<<!!!>>>>>>>>>>
